          ...
          <form  className='myForm' onSubmit={handleSubmit}>
                        ...
                        {item.category && (
                          ...
                          >
                            <label>
                              <input
                                type="checkbox"
                                checked={values.items.some(
                                  (i) => i.category === item.category
                                )}
                                onChange={(e) => {
                                  if (e.target.checked) {
                                    const itemsToAdd = itemsApiResponse.filter(
                                      (i) => i.category === item.category
                                    );
                                    myarrayAssist.form.setFieldValue(
                                      'items',
                                      [...values.items, ...itemsToAdd]
                                    );
                                  } else {
                                    myarrayAssist.form.setFieldValue(
                                      'items',
                        ...
                        <div>
                          <label>
                            <input
                              ...
                              onChange={(e) => {
                                if (e.target.checked) {
                                  myarrayAssist.form.setFieldValue('items', [
                                    ...values.items,
                                    item,
                                  ]);
                                } else {
            ...
            position:"relative",
              ...
              left:"500px"
                            ...
                            }} type="submit">Apply tax to 6 item</button>
          </form>
        )}
      </Formik>
    </div>
